    ...
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
       ...
       <div className="flex items-center gap-4 rounded-2xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm">
         ...
         <div>
           ...
           <h3 className="font-display text-2xl font-bold text-emerald-700">₱{kpis.totalCollected.toLocaleString()}</h3>
         </div>
       </div>

       {/* Installment Plans - Amber */}
       <div className="flex items-center gap-4 rounded-2xl border border-amber-200 bg-amber-50 p-5 shadow-sm">
         ...
         <div>
           ...
           <h3 className="font-display text-2xl font-bold text-amber-700">{kpis.installmentPlansCreated.toLocaleString()}</h3>
         </div>
       </div>
